...
INTEGRATION_TIME_TO_STR = collections.OrderedDict(((v, k) for k, v in STR_TO_INTEGRATION_TIME.items()))
...
CHANNEL_TO_STR = collections.OrderedDict(((v, k) for k, v in STR_TO_CHANNEL.items()))
